...
async function getImageUrlFromAssetId(assetId) {
    ...
    return "https:" + asset.fields.file.url + "?fm=jpg&fl=progressive"
}
...
export async function getCategoryBySlug(slug) {
    ...
    return {
        ...
        parentCategoryId: category.fields.parentCategory === undefined ? undefined : category.fields.parentCategory.sys.id,
    }
}
...
export async function getDirectChildrenForCategory(categoryId) {
    const response = await client.getEntries({
        content_type: "category",
        "fields.parentCategory.sys.id": categoryId,
    })
...
export async function getAllRootCategories() {
    const response = await client.getEntries({
        content_type: "category",
        "fields.parentCategory[exists]": false,
    })
    if (!response.items) {
        return []
    }
